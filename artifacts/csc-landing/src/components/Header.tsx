        ...
        <div className="py-2.5">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border-2 border-[#003366]/20 focus:border-[#F06421] focus:outline-none text-sm bg-gray-50 focus:bg-white transition-all"
            />
          </div>
        </div>
      </div>
