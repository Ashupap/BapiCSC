...
const slides = [
  ...
  },
  {
    ...
    titleOd: "ଆଧାର ଓ PAN\nଏଠିକୁ ଆସନ୍ତୁ",
    subEn: "UCL Aadhaar update centre. Mobile, email, demographic & document updation — same day.",
    subOd: "UCL ଆଧାର ଅଦ୍ୟତନ କେନ୍ଦ୍ର। ମୋବାଇଲ, ଇ-ମେଲ, ଡ଼ିମୋଗ୍ରାଫିକ ଓ ଦଲିଲ ଅଦ୍ୟତନ — ସେଦିନ।",
    badge: "Authorised UCL Centre",
    poster: aadhaarPoster,
    posterLabel: "UCL Aadhaar Services",
    posterAccent: "#ff8844",
    stats: [{ v: "Same Day", l: "Processing" }, { v: "UCL", l: "Authorized" }, { v: "Secure", l: "Update" }],
    orb1: "#ff8844",
    orb2: "#ff4400",
  },
  {
    ...
    accent: "#4ade80",
    titleEn: "PM Welfare Schemes\nAvailable Here",
    titleOd: "ପ୍ରଧାନ ମନ୍ତ୍ରୀ\nକଲ୍ୟାଣ ଯୋଜନା",
    subEn: "PM Kisan, Ayushman Bharat, E-Shram & more — register online, get benefits instantly.",
    subOd: "PM କିସାନ, ଆୟୁଷ୍ମାନ ଭାରତ, E-Shram ଓ ଅଧିକ — ଅନ୍ଲାଇନ ନଥିଭୁକ୍ତ, ତୁରନ୍ତ ଲାଭ।",
    badge: "Govt. Welfare Schemes",
    poster: pmWelfarePoster,
    posterLabel: "PM Welfare Schemes",
    posterAccent: "#22c55e",
    stats: [{ v: "9+", l: "PM Schemes" }, { v: "Free", l: "Registration" }, { v: "Instant", l: "Benefits" }],
    orb1: "#22c55e",
    orb2: "#16a34a",
  },
];
